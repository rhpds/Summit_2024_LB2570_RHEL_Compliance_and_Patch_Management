...
Jetez également un coup d'oeil à notre présentation sur les meilleurs pratiques avec Ansible: en anglais link:../../decks/ansible_best_practices.pdf[Pratiques exemplaires disponibles]
...
image::../../images/ansible_smart_mgmt_diagram.png#centreme[diagramme automatique de laboratoire de gestion intelligente]
